...
# =============================================================================
# Example usage:
# (Assuming that the helper function `signed_angle` is defined and jitted as in your code.)
if __name__ == "__main__":
    import jax.random as jr

    # Example vectors (each a 1D array) and a plane normal.
    key = jr.PRNGKey(0)
    # For example, v1 and v2 in 3D
    ...
    angle_radians = minimal_line_signed_angle(v1, v2, plane_normal, to_degree=False)
    # And in degrees:
    angle_degrees = minimal_line_signed_angle(v1, v2, plane_normal, to_degree=True)
    
    print("Minimal signed angle (radians):", angle_radians)
    print("Minimal signed angle (degrees):", angle_degrees)
