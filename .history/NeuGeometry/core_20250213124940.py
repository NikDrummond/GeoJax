...
@jit
def minimum_theta(
    v1: jnp.ndarray, v2: jnp.ndarray, plane_normal: jnp.ndarray, to_degree: bool = False, reject_fn = reject
) -> jnp.ndarray:
    """
...
def align_point_cloud(coords: jnp.ndarray,
    ...
    center : bool or jnp.ndarray
        If a Boolean, then True subtracts the point clouds mean (False does nothing).
