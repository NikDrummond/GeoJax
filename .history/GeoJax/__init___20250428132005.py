...
from .projection import (
    ...
    project_to_vector, project_to_plane, project_to_xy_plane, project_to_yz_plane, project_to_xz_plane, orthographic_projection, stereographic_projection, equirectangular_projection, mercator_projection, lambert_azimuthal_projection, project_to_2d
)
...
__all__ = [
    ...
    # projection
    "reject_axis", "project_to_sphere", "project_to_vector", "project_to_plane", "project_to_xy_plane", "project_to_yz_plane", "project_to_xz_plane", "orthographic_projection", "stereographic_projection", "equirectangular_projection, mercator_projection, lambert_azimuthal_projection, project_to_2d,
