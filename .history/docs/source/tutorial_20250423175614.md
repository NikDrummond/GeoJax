...
2. [Projections and Reflections](#projections-and-reflections)
3. [Rotation and Orientation](#rotation-and-orientation)
4. [Coordinate Alignment](#coordinate-alignment)
5. [Bounding Shapes](#bounding-shapes)
6. [Geometric Checks and Basis Vectors](#geometric-checks-and-basis-vectors)
7. [Circular Statistics](#circular-statistics)
8. [Mahalanobis Distance and Outliers](#mahalanobis-distance-and-outliers)
